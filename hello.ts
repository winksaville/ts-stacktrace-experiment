...
function myMarker() {
    console.log(TraceMarker.here(2).toString());
}

function main() {
    let tm = new TraceMarker();
    console.log(`hi ${TraceMarker.here().func}:${TraceMarker.here().line}`);
    tm.mark(); console.log(`${tm.getLocation()}`);
    myMarker();
    console.log(`hi ${TraceMarker.here().func}:${TraceMarker.here().line}`);
}

console.log(TraceMarker.here().toString());
console.log(`${TraceMarker.here()}`);
